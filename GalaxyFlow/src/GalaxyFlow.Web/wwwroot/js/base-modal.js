...
*/
/* 使用说明
1、modals普通alert共有四个，分别为modals.info(), modals.correct(), modals.warn(), modals.error(), 使用方法有两个分别为modals.info('...')和modals.info({...})
2、modals确认confirm一个，为modals.confirm('...')或modals.confirm({...})
3、modals打开弹出窗一个，为modals.openWin()
*/
